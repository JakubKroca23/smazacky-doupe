...
export default function SignUpSuccessPage() {
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <div className="fixed top-20 left-1/4 w-96 h-96 bg-success/10 rounded-full blur-3xl -z-10" />
        ...
        <Card className="w-full max-w-md border-border/50 bg-card/50 backdrop-blur-xl text-center">
          <CardHeader>
            <div className="flex justify-center mb-4">
              <div className="relative p-4 rounded-full bg-success/10 border border-success/30">
                <Mail className="h-10 w-10 text-success" />
                <div className="absolute inset-0 blur-lg bg-success/20 -z-10 rounded-full" />
              </div>
            </div>
